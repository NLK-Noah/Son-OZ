...
define
   ...
   proc {TestPartition P2T Mix}
      M = [partition([silence(duration:0.001)])] % 0.001s de silence = 44 samples à 44100 Hz
      S = {Mix P2T M}
   in
      {AssertEquals {Length S} 44 'TestPartition: silence generates correct sample count'}
   end
